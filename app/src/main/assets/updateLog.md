...
**2026/04/22**
- 修复发现页html内联内容高度测量问题，确保内容完整显示
- 优化发现页useWeb加载逻辑，加载时显示加载圈，加载完成后才显示内容
- 修复发现页useWeb在夜间模式下背景色不匹配问题
- 发现页useWeb新增高度平滑过渡动画，减少视觉跳动
- 优化WebView内联内容高度测量逻辑，减少测量次数提升性能
- 修复弹跳感问题，减少视觉跳感，提升用户体验
